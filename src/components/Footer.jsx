      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><Link to="/how-it-works#ai-analysis" className="text-base text-gray-500 hover:text-gray-900">AI Matching</Link></li>
              <li><Link to="/how-it-works#ai-analysis" className="text-base text-gray-500 hover:text-gray-900">Talent Sourcing</Link></li>
              <li><Link to="/how-it-works#outreach" className="text-base text-gray-500 hover:text-gray-900">Analytics</Link></li>
              <li><Link to="/how-it-works#meeting-setup" className="text-base text-gray-500 hover:text-gray-900">Interview Setup</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><Link to="/#contact-us" className="text-base text-gray-500 hover:text-gray-900">Help Center</Link></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><Link to="/#contact-us" className="text-base text-gray-500 hover:text-gray-900">Contact Us</Link></li>
